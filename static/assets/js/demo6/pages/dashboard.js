...
var KTDashboard = function() {
    ...
    var datatableLatestOrders = function() {
        if (jQuery('#kt_datatable_latest_orders').length === 0) {
            return;
        }

        var datatable = jQuery('#kt_datatable_latest_orders').KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
    ...
    // Data Grid
    var datatableDataGrid = function() {

		var datatable = jQuery('#base_translation').KTDatatable({
        ...
        jQuery('#kt_form_status').on('change', function() {
        datatable.search(jQuery(this).val().toLowerCase(), 'Status');
        });

        jQuery('#kt_form_type').on('change', function() {
        datatable.search(jQuery(this).val().toLowerCase(), 'Type');
        });

        jQuery('#kt_form_status,#kt_form_type').selectpicker();

    };

    // Calendar Init
    var calendarInit = function() {
        if (jQuery('#kt_calendar').length === 0) {
            return;
        }
        ...
        jQuery('#kt_calendar').fullCalendar({
            isRTL: KTUtil.isRTL(),
            header: {
    ...
    var earningsSlide = function() {
        var carousel1 = jQuery('#kt_earnings_widget .kt-widget30__head .owl-carousel');
        var carousel2 = jQuery('#kt_earnings_widget .kt-widget30__body .owl-carousel');
        ...
        jQuery(document).on('click', '.carousel', function() {
        ...
        carousel1.on('changed.owl.carousel', function () {
            var index = jQuery(this).find('.owl-item.active.center').find('.carousel').attr('data-position');
            if (index) {
                carousel2.trigger('to.owl.carousel', index);
            }
        });
...
// Based on Chartjs plugin - http://www.chartjs.org/
// var bandwidthChart1 = function() {
//     if (jQuery('#kt_chart_bandwidth1').length == 0) {
//         return;
//     }
